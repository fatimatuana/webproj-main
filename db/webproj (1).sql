...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 19. Jan 2022 um 12:58
...
INSERT INTO `guests` (`ID`, `Gender`, `Firstname`, `Lastname`, `Username`, `Email`, `Password`) VALUES
(3, 'on', 'guest1', 'blabla', 'guest1', 'guest1@test.at', '$2y$10$J8Yc7yhISg9G/7sb6g2LJerjEU3JQ8T4A3BER1CSQJRNsPX6YXkym'),
(4, 'on', 'guest2', 'lululu', 'guest2', 'guest2@test.at', '$2y$10$KsVgBUB6LLE9arIIfwe6WO3oVxjplg7r6WjtNy4Okb0v2wzmrjBoi'),
(6, 'female', 'guest3', 'a', 'guest3', 'guest3@test.at', '$2y$10$y6byO8mjDpFi/owsPJuJLepZo0J2q1PkwpVNHcl2uIgRRZoKhpabq'),
(8, 'on', 'Test1', 'huhuhu', 'test1', 'test1@huhuhu.at', '$2y$10$FGBfbGLq6aTQX/4IxGTG6OCzpegg5xh0HYaBtlGYHFkrQu/kPNyb6'),
(9, 'on', 'asdf', 'asdf', 'asdf', 'asdf@asdf.at', '$2y$10$yla3cjIFL9gOVo7ZrsYCpe/xdpiwY40mgkmB9/2ZtaAsCgnJFylLK'),
(10, 'male', 'Sophia', 'Ehmayer', 'gast1', 'sophia@lala.at', '$2y$10$nIrFJuD/80fGMeAclsyAm.e/6ia6zLi31xd03Ju45bn9yY4aDtEO.');
...
(1, 'testuser1', '', 'testuser123', 'testuser1', '$2y$10$FDtcSpLM24SxHfx7qTJ.Hu14Ee7f.TWUDQ0Kcw/Ad1LDM82aOilXC', 'testuser@gmail.com', 'guest', 0),
...
(10, 'test1234', 'female', 'Test123', 'Test1234', '$2y$10$2TS/I2iyjxY2m.ivbCT.fOiI8OxihX3TClUD6KoneXkge2d/m9bPa', 'test123@123.at', 'guest', 0),
(14, 'lalala', 'male', 'Lalala', 'lalala', '$2y$10$YS.eiNfyZHYvUIKVDqy3fOKEVVwGASfkmPGGPtZC8ZvR2U1lrkIc6', 'lalala@123.at', 'guest', 0);
